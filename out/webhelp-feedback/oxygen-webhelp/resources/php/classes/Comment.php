				...
				if (($db->Field('userId')==$idUser && $db->Field('state')=='new')||$isForAdmin || $db->Field('state')=='approved'){
					...
					if (($idUser==$db->Field('userId') && $db->Field('state')=='new') && !$isForAdmin){
						...
						if (!$this->isAnonymous($idUser)){
							...
							$toReturn.="<input type='button' class='bt_delete' title='".Utils::translate("delete")."' onclick='showConfirmDeleteDialog(".$parent.")' value='".Utils::translate("delete")."'>";
							$toReturn.="<input type='button' class='bt_edit' title='".Utils::translate("edit")."' onclick='editPost(".$parent.")' value='".Utils::translate("edit")."'>";
							$toReturn.="</div>";
						}
					}
					...
					if ($isForAdmin){
						...
						if ($db->Field("state")!="approved" ){
							$toReturn.="<input type='button' class='bt_delete' title='".Utils::translate("delete")."' onclick='showConfirmDeleteDialog(".$parent.")' value='".Utils::translate("delete")."'>";
							$toReturn.="<input type='button' class='bt_edit' title='".Utils::translate("edit")."' onclick='editPost(".$parent.")' value='".Utils::translate("edit")."'>";
							$toReturn.="<input type='button' class='bt_approve' title='".Utils::translate("approve")."' onclick='moderatePost(".$parent.",\"approved\")' value='".Utils::translate("approve")."'>";
						}else{
							if ($db->Field("state")=="approved"){
								$toReturn.="<input type='button' class='bt_delete' title='".Utils::translate("delete")."' onclick='showConfirmDeleteDialog(".$parent.")' value='".Utils::translate("delete")."'>";
								$toReturn.="<input type='button' class='bt_edit' title='".Utils::translate("edit")."' onclick='editPost(".$parent.")' value='".Utils::translate("edit")."'>";
